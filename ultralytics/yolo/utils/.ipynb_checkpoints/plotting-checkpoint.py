...
def plot_results(file='path/to/results.csv', dir='', segment=False, pose=False, classify=False, on_plot=None):
    ...
    ax[1].legend()
    ax[2].legend()
    ax[3].legend(bbox_to_anchor=(1,0),loc='lower right')
    ax[4].legend(bbox_to_anchor=(1,0),loc='lower right')
    ax[5].legend()
    ax[6].legend()
    ax[7].legend()
    ax[8].legend(bbox_to_anchor=(1,0),loc='lower right')
    ax[9].legend(bbox_to_anchor=(1,0),loc='lower right')
    # ax[9].legend(bbox_to_anchor=(1,0),loc='lower right',fontsize=8,title_fontsize=5)
    # for a in ax:
    #     a.legend(fontsize=10,title_fontsize=8)
